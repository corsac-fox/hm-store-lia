...
function About () {
    return (
        <div className='about'>
            <img className='about-photo' src='src\assets\photos\personal.png'/>
            <h1>Обо мне</h1>
            <div className='about-content'>
                ...
                <p>Процессы творчества, болтовня, гоблинкорный лайфстайл живут у меня в телеге: https://t.me/liaembr</p>
            </div>
